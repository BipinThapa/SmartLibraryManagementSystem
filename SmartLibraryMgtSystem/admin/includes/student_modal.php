            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="student_add.php">
                ...
                <div class="form-group">
                 ...
                 <div class="form-check checkStudent" style="margin: 0px 0px 8px 150px;">
                <input class="form-check-input" type="checkbox" name="statusNewStudent">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="student_edit.php">
                ...
                <div class="form-group">
                  ...
                  <div class="form-check checkStudent" style="margin: 0px 0px 8px 150px;">
                    <input id="edit_statusEditStudent" class="form-check-input" type="checkbox" name="statusEditStudent">
                    <label class="form-check-label">Active</label>
                  </div>
            </div>
            <div class="modal-footer">
