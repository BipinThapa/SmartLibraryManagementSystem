...
$(function(){
  $(document).on('click', '#append', function(e){
    e.preventDefault();
    $('#append-div').append(
      '<div class="form-group"><label for="" class="col-sm-3 control-label">ISBN</label><div class="col-sm-9"><input type="text" class="form-control" name="isbn[]"><i class="fa fa-minus removeReturn"></i></div></div>'
    );
  });

  $(document).on('click','.removeReturn',function(e){
    e.preventDefault();
