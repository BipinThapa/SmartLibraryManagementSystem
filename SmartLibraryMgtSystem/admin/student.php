...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#edit_statusEditStudent').val(response.status);
        if($('#edit_statusEditStudent').val()==1){
            $('#edit_statusEditStudent').attr('checked',"checked");
        }else {
            $('#edit_statusEditStudent').removeAttr('checked');
        };
